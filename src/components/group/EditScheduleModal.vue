        ...
        <form @submit.prevent="handleSubmit">
          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div class="sm:flex sm:items-start">
              <div class="w-full">
                <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">编辑日程</h3>
...
watch(() => props.schedule, (newSchedule) => {
  if (newSchedule) {
    Object.assign(form, {
      ...
      deadline: newSchedule.deadline ? newSchedule.deadline.slice(0, 16) : '',
      priority: newSchedule.priority || 'Routine',
      tags: [...(newSchedule.tags || [])],
      assignees: [...(newSchedule.assignees || [newSchedule.assignee].filter(Boolean))]
    })
  }
}, { immediate: true })
